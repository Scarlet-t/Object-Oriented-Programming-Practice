...
namespace seneca {
	class Patient : public IOAble {
		char* m_name;
		int m_ohip;
		// represents the patientís ticket for the lineup
		// encapsulates all relevant information about the patientís position in the queue, such as their arrival time and priority level.
		Ticket m_ticket;
	public:
